...
%\newpage
%イントロ
\input{subfiles/intro/intro.tex}

\begin{multicols}{2}
%コンセプト
\input{subfiles/concept/concept.tex}

%サスペンション
\input{subfiles/suspension/merge.tex}

%ボディ
\input{subfiles/body/merge.tex}

%パワートレイン
\input{subfiles/powertrain/merge.tex}

%エルゴノミクス
\input{subfiles/ergonomics/merge.tex}
